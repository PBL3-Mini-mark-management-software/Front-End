...
const addEmployee = async () => {
  try {
    const response = await axios.post('http://localhost:8082/api/employees', newEmployee.value);
...
const editEmployeeById = async () => {
  try{
    const response = await axios.patch(`http://localhost:8082/api/employees/${editEmployee.value.employee_id}`, editEmployee.value);
...
const deleteEmployeeById = async (employeeId) => {
  try {
    await axios.delete(`http://localhost:8082/api/employees/${employeeId}`);
...
<template>
    <div class="temp">
        ...
        <div class="main-right">
            <Taskbar />
            <div class="container">
                <div class="overlay" v-if="showEditEmployeeForm || showAddEmployeeForm" @click="showEditEmployeeForm = false"></div>
                <div class="header2">
                    <h3>Nhân viên </h3>
                ...
                <div v-if="showAddEmployeeForm" class="add-employee-form">
                  ...
                  <form @submit.prevent="addEmployee">
                    ...
                    <div>
                      ...
                      <input v-model="newEmployee.phone" type="text" id="phone" required />
                    </div>
                    <div>
